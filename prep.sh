...
head -n $((1*`cat $DATA_ROOT/train.txt | wc -l`/50)) $DATA_ROOT/train.txt > $DATA_ROOT/train2.txt
head -n $((1*`cat $DATA_ROOT/train.txt | wc -l`/5)) $DATA_ROOT/train.txt > $DATA_ROOT/train20.txt
head -n $((2*`cat $DATA_ROOT/train.txt | wc -l`/5)) $DATA_ROOT/train.txt > $DATA_ROOT/train40.txt
head -n $((3*`cat $DATA_ROOT/train.txt | wc -l`/5)) $DATA_ROOT/train.txt > $DATA_ROOT/train60.txt
head -n $((4*`cat $DATA_ROOT/train.txt | wc -l`/5)) $DATA_ROOT/train.txt > $DATA_ROOT/train80.txt
